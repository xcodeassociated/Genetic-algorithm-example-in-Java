...
public class TravelingSalesmanProblemImplementation {
    // variables
    ...
    static private int bestChromosome;
    static private int bestGeneration;
    ...
    public TravelingSalesmanProblemImplementation(String fileName) {
        this.FILE = fileName;
    }
    ...
    public static void initialize_ds() {
        ...
        try (BufferedReader readBuffer = new BufferedReader(new FileReader(FILE))) {
    ...
    private static int genRandom(int x) {
